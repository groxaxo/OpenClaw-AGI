#!/bin/bash
# OpenClaw-OPD Qwen 3.5 Vision launcher — 2x RTX 3090 (48 GB total)
#
# GPU layout:
...
export OPENCLAW_RECORD_FILE="${OPENCLAW_RECORD_FILE:-${SCRIPT_DIR}/results/qwen3_5_4b_vision_opd_3090_2x_record.jsonl}"
...
echo "========================================================"
echo "  OpenClaw-OPD  |  Unsloth Qwen 3.5 Vision  |  2x RTX 3090"
